...
const ImgCell3 = ({Source})=>{
  return (
      <img src={Source} style={{borderRadius:'50%', height:'60px'}}/>
  )
}

export const customersGrid = [
  // {
  //   field: 'selected', // Make sure 'selected' field exists in your data
  //   headerName: 'Select',
  //   type: 'checkbox',
  //   width: 50,
  // },
  { 
    ...
    headerName: 'Profile',
    width: '100',
    renderCell: (params)=> <ImgCell3 Source={params.value} />,
    textAlign: 'Center' 
  },
  { 
    field: 'CustomerName',
    headerName: 'Name',
    width: '150',
    renderCell: (params)=> <div> <span>{params.row.CustomerName}</span> <p>{params.row.CustomerEmail}</p> </div>, 
    textAlign: 'Center' 
  },
      ...
      if (Status === 'Active') {
        statusComponent = (
          <span style={{display:'flex', alignItems:'center'}}>
            <div style={{ height: '12px', width: '12px', borderRadius: '50%', backgroundColor: 'Lightgreen'}}></div>
        ...
        statusComponent = (
          <span style={{display:'flex', alignItems:'center'}}>
            <div style={{ height: '12px', width: '12px', borderRadius: '50%', backgroundColor: 'Skyblue'}}></div>
            <p className='ml-2'>{Status}</p>
          </span>
        );
      } else {
...
const ImgCell2 = ({Source})=>{
  return (
      <img src={Source} style={{borderRadius:'50%', height:'80px', marginLeft:'auto', marginRight:'auto'}}/>
  )
}
...
export const employeesGrid = [
  { 
    ...
    headerName: 'Employee',
    width: '100',
    renderCell: (params) =>  <ImgCell2 Source={params.value}  /> ,
    textAlign: 'Center' 
  },
...
export const chatData = [
  ...
  },
  {
    ...
    desc: 'Salkyy sent you new message',
    time: '11:56 AM',
  },
  {
    image:
...
const ImgCell = ({Source})=>{
  return (
      <img src={Source} style={{borderRadius:'10%', height:'80px', marginLeft:'auto', marginRight:'auto'}}/>
  )
}
...
export const ordersGrid = [
  {
    field:'Product Image',
    headerText: 'Image',
    renderCell: (params) =>  <ImgCell Source={params.value}  />,
    textAlign: 'Center',
    width: '120',
  ...
  },
  {
    field : 'Status',
    headerText: 'Status',
    renderCell:(params)=> <button style={{backgroundColor:params.StatusBg}} > {params.value} </button>  ,
    textAlign: 'Center',
    width: '120',
    cellClassName: (params) =>
        clsx('super-app', {
          negative: params.value === "pending",
